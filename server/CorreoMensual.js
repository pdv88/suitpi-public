            ...
            (err, result) => {
              ...
              if (result.length > 0) {
                ...
                result.forEach((marca) => {
                  let plazo30dias = new Date();
                  plazo30dias.setMonth(plazo30dias.getMonth() + 1);
                  // filter brands that fechaVig deadline is in the next 7 days
                  if (marca.fechaVig) {
                    if (
                      new Date(marca.fechaVig) < plazo30dias &&
                  ...
                  if (marca.fechaDenegacion) {
                    ...
                    if (deadlineDate >= today && deadlineDate < plazo30dias) {
                ...
                if (
                  ...
                  const source = fs
                    .readFileSync("./email_templates/month_report.html", "utf8")
                    .toString();
                  ...
                  const mailOptions = {
                    ...
                    to: user.mail,
                    subject: "SuitPI - Informe Mensual",
                    html: htmlToSend,
                  };
